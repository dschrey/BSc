...
public class UISegmentDistances : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        {
            AssessmentManager.Instance.SetSegmentObjectiveDistance(_selectedSegment.SegmentID, DataManager.Instance.Settings.SegmentLength);
        }
    }
    ...
    private void CreateSegmentSelectionObjects()
    {
        foreach (SegmentObjectData segmentData in _pathPreviewCreator.SpawnedSegments)
        {
            ...
            segmentSelection.Initialize(segmentData.SegmentID, DataManager.Instance.Settings.SegmentLength, _toggleGroup, segmentData.SegmentID == 0);
